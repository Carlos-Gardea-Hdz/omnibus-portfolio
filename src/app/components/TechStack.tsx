...
export default function TechStack() {
  ...
  return (
    <section id="stack" className="bg-[#F5F6FA] dark:bg-[#0A0C10] py-24">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16">
          ...
          >
            ...
            <p className="font-body text-[#64748B] dark:text-[#6B7A99] text-lg max-w-lg">
              {lang === 'es'
          ...
          {techCategories.map((category, catIdx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <span className="font-code text-[11px] tracking-[0.15em] uppercase text-[#64748B] dark:text-[#6B7A99]">
                  {category.label}
                </span>
              </div>
